...
//			tfod.shutdown();
		...
		if (opModeIsActive()) {
			...
			while (opModeIsActive()) {
				telemetry.addData("linear acceleration", robot.imu.getLinearAcceleration().toString());
				telemetry.addData("linear acceleration1", robot.imu1.getLinearAcceleration().toString());
				telemetry.addData("acceleration", robot.imu.getAcceleration().toString());
				telemetry.addData("acceleration1", robot.imu1.getAcceleration().toString());
				telemetry.addData("angular velocity", robot.imu.getAngularVelocity().toString());
				telemetry.addData("angular velocity1", robot.imu1.getAngularVelocity().toString());
				telemetry.addData("position", robot.imu.getPosition().toString());
				telemetry.addData("position1", robot.imu1.getPosition().toString());
