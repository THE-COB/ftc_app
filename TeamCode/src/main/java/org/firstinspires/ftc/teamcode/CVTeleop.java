...
public class CVTeleop extends AvesAblazeOpmode {
	...
	public void runOpMode() {
		...
		extensionPosition=robot.extension.getPosition();
		...
		while(opModeIsActive()) {
			...
			robot.extension.setPosition(Range.clip(extensionPosition,startingPosition,startingPosition+0.92));
			...
			//	while (opModeIsActive() && gamepad1.x) ;
				...
				extensionPosition =startingPosition+0.92;
				robot.extension.setPosition(extensionPosition);
