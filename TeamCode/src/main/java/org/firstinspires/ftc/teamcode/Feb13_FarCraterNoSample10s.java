...
@Autonomous(name = "DepotFarCraterNoSample10s", group = "AAA")
public class Feb13_FarCraterNoSample10s extends  AvesAblazeOpmode {
...
while(waitTime.seconds()<10&&opModeIsActive());
