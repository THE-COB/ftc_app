...
@TeleOp(name = "ScoringMinerals", group = "AAA")
public class Jan22_ScoringMineralTest extends  AvesAblazeOpmode {
	...
	public void runOpMode() {
		...
		if(position.equals("center")){
			...
			robot.arm.setPower(1);
			while(opModeIsActive()&&robot.extension.getCurrentPosition()-closedExtension<2873&&robot.arm.getCurrentPosition()-closedArm<400){
			...
			while(opModeIsActive()&&robot.arm.getCurrentPosition()-closedArm<400){
