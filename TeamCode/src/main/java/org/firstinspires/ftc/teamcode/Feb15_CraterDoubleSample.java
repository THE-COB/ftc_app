...
@Autonomous(name = "Feb15CraterDoubleSample", group = "AAA")
public class Feb15_CraterDoubleSample extends  AvesAblazeOpmode {
...
if(position.equals("right")){
	...
	while (opModeIsActive() && drivetime.seconds() < 0.75 && runtime.seconds() < 28.5) {
	}
	if (drivetime.seconds() > 0.9) {
		stopMotors();
	} else {
